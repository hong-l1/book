...
// Source: internal/service/article_gorm.go
//
// Generated by this command:
//
//	mockgen -source=internal/service/article_gorm.go -package=svcmocks -destination=internal/service/mocks/article.mock.go
//
