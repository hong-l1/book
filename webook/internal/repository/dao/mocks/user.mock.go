...
import (
	...
	dao "github.com/hong-l1/project/webook/internal/repository/dao"
...
func (m *MockUserDao) Edit(ctx context.Context, user domain.User) error {
	m.ctrl.T.Helper()
...
func (m *MockUserDao) FindByEmail(ctx context.Context, user domain.User) (dao.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUserDaoMockRecorder) FindByEmail(ctx, user any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindByEmail", reflect.TypeOf((*MockUserDao)(nil).FindByEmail), ctx, user)
}

// FindById mocks base method.
func (m *MockUserDao) FindById(ctx context.Context, user domain.User) (dao.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUserDaoMockRecorder) FindById(ctx, user any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindById", reflect.TypeOf((*MockUserDao)(nil).FindById), ctx, user)
}
