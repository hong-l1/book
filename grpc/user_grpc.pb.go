...
type UserServiceClient interface {
	GetById(ctx context.Context, in *User, opts ...grpc.CallOption) (*A, error)
}
...
func (c *userServiceClient) GetById(ctx context.Context, in *User, opts ...grpc.CallOption) (*A, error) {
...
type UserServiceServer interface {
	GetById(context.Context, *User) (*A, error)
...
func (UnimplementedUserServiceServer) GetById(context.Context, *User) (*A, error) {
...
func _UserService_GetById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetById(ctx, req.(*User))
	}
